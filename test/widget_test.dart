...
void main() {
  testWidgets('Counter increments smoke test', (WidgetTester tester) async {
    ...
    CartDataRepository cartDataRepository = CartDataRepository(auth: auth, dioClient: dioClient, shoppingRepository: shoppingRepository, couponRepository: couponRepository);
