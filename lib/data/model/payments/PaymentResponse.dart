...
PaymentResponseModel paymentResponseFromJson(String str) => PaymentResponseModel.fromJson(json.decode(str));
String paymentResponseToJson(PaymentResponseModel data) => json.encode(data.toJson());
class PaymentResponseModel {
  ...
  PaymentResponseModel.fromJson(dynamic json) {
    ...
    bookingget = json['bookingget'] != null ? Bookingget.fromJson(json['bookingget']) : null;
  }
  String? status;
  String? message;
  String? bookingid;
...
PaymentResponseModel copyWith({  String? status,
  String? message,
  String? bookingid,
  String? payments,
  String? serviceInsrted,
  Bookingget? bookingget,
}) => PaymentResponseModel(  status: status ?? this.status,
...
Bookingget bookinggetFromJson(String str) => Bookingget.fromJson(json.decode(str));
...
class Items {
  ...
  Items.fromJson(dynamic json) {
    ...
    createdAt = json['created_at'];
    updatedAt = json['updated_at'];
    businessService = json['business_service'] != null ? BusinessService.fromJson(json['business_service']) : null;
  }
  num? id;
  num? bookingId;
...
BusinessService businessServiceFromJson(String str) => BusinessService.fromJson(json.decode(str));
String businessServiceToJson(BusinessService data) => json.encode(data.toJson());
class BusinessService {
  ...
  num? discountedPrice;
  Category? category;
BusinessService copyWith({  num? id,
  String? name,
  String? slug,
  String? description,
  dynamic mobileLongDescription,
  ...
  num? discountedPrice,
  Category? category,
}) => BusinessService(  id: id ?? this.id,
  name: name ?? this.name,
  slug: slug ?? this.slug,
  description: description ?? this.description,
  mobileLongDescription: mobileLongDescription ?? this.mobileLongDescription,
  mobileLongDescription2: mobileLongDescription2 ?? this.mobileLongDescription2,
  mobileLongDescription3: mobileLongDescription3 ?? this.mobileLongDescription3,
  mobileLongDescription4: mobileLongDescription4 ?? this.mobileLongDescription4,
