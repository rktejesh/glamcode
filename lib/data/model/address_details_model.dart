...
AddressDetailsModel copyWith({  String? status,
  String? message,
  List<AddressDetails>? addressDetails,
}) => AddressDetailsModel(  status: status ?? this.status,
...
class AddressDetails {
  ...
  String? createdAt;
  String? updatedAt;
AddressDetails copyWith({  num? addressId,
  String? addressHeading,
  num? userId,
  String? address,
  String? street,
  ...
  String? createdAt,
  String? updatedAt,
}) => AddressDetails(  addressId: addressId ?? this.addressId,
