...
Bookings copyWith({  String? status,
  String? message,
  List<OngoingBookingsArr>? ongoingBookingsArr,
}) => Bookings(  status: status ?? this.status,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (ongoingBookingsArr != null) {
      map['OngoingBookingsArr'] = ongoingBookingsArr?.map((v) => v.toJson()).toList();
    }
    return map;
  }
...
OngoingBookingsArr ongoingBookingsArrFromJson(String str) => OngoingBookingsArr.fromJson(json.decode(str));
String ongoingBookingsArrToJson(OngoingBookingsArr data) => json.encode(data.toJson());
class OngoingBookingsArr {
  ...
  String? serviceCat;
OngoingBookingsArr copyWith({  String? userName,
  num? bookingId,
  String? bookingOrderDate,
  String? bookingDate,
  String? bookingTime,
  ...
  String? serviceMainCat,
  String? serviceCat,
}) => OngoingBookingsArr(  userName: userName ?? this.userName,
