...
BookingSlotsModel bookingSlotsModelFromJson(String str) => BookingSlotsModel.fromJson(json.decode(str));
String bookingSlotsModelToJson(BookingSlotsModel data) => json.encode(data.toJson());
...
BookingSlotsModel copyWith({  String? status,
  String? message,
  String? startTime,
  String? endTime,
  List<SlotArray>? slotArray,
  List<Bookings>? bookings,
}) => BookingSlotsModel(  status: status ?? this.status,
...
class Bookings {
  ...
  num? id;
  String? dateTime;
Bookings copyWith({  num? id,
  String? dateTime,
}) => Bookings(  id: id ?? this.id,
...
SlotArray copyWith({  String? date,
  String? timeToShow,
  String? timeToDisplay,
}) => SlotArray(  date: date ?? this.date,
