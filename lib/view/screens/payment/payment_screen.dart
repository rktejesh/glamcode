...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  bool _handlePayment(CartData cartData, User user) {
    ...
    var options = {
      ...
      'image':
          'https://www.glamcode.in/user-uploads/front-logo/1734a4db1beccdd08af159f42ade427a.png.webp',
      'currency': 'INR',
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    paymentRepository
        .bookingsApi(cartData, response.paymentId ?? "")
        .then((value) {
      if (value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: loading ? const LoadingScreen() : ListView(
        children: <Widget>[
          ListTile(
            isThreeLine: false,
            dense: true,
            ...
            tileColor:
                _selectedOption == 0 ? const Color(0xFFA854FC) : Colors.white,
            onTap: () {
              setState(() {
                _selectedOption = 0;
              });
          ...
          ListTile(
            ...
            style: ListTileStyle.drawer,
            tileColor:
                _selectedOption == 1 ? const Color(0xFFA854FC) : Colors.white,
            onTap: () {
              setState(() {
                _selectedOption = 1;
              });
      ...
      bottomNavigationBar: BlocBuilder<CartDataBloc, CartDataState>(
        builder: (context, cartState) {
          if (cartState is CartDataLoading) {
            ...
            return loading ? const SizedBox() : BottomAppBar(
              child: Row(
                      ...
                      child: TextButton(
                          ...
                          onPressed: () async {
                            if (_selectedOption == 1) {
                              ...
                              paymentRepository
                                  .bookingsApi(cartState.cartData, "cash")
                                  .then((value) {
                                if (value) {
                                  context.read<CartBloc>().add(CartCleared());
                                  Navigator.of(context).pushNamedAndRemoveUntil(
