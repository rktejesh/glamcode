                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          tileColor: state.addonList.contains(addonList[index]) ? const Color(0xFFA854FC) : Colors.white,
                          onTap: () {
                            setState(() {
                              state.addonList.contains(addonList[index])
                                  ? context.read<AddonBloc>().add(
                                  AddonItemRemoved(addonList[index]))
                                  : context.read<AddonBloc>().add(
                                  AddonItemAdded(addonList[index]));
                            });
                          },
                          title: Row(
                            ...
                            children: [
                              Text(
                                  "${addonList[index].name}", style: TextStyle(fontSize: Dimensions.fontSizeLarge, color: state.addonList.contains(addonList[index]) ? Colors.white : Colors.black),),
                              Text(
                                  "₹${addonList[index].price}", style: TextStyle(fontSize: Dimensions.fontSizeLarge, color: state.addonList.contains(addonList[index]) ? Colors.white : Colors.black),),
                            ],
                          ),
                        );
                      },
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Rs. ${cartState.cartData.amountToPay}", style: const TextStyle(fontWeight: FontWeight.bold),)
                      ],
                    ),
                  ),
                  Expanded(
