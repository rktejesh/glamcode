      ...
      child: Container(
        ...
        child: ListView(
          children: [
            ...
            drawerTile("Membership", Icons.card_membership_outlined, null, context),
            drawerTile("Blog", Icons.comment_bank, null, context),
            drawerTile("Gallery", Icons.photo_library, (){
              Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(
                      builder: (context) => const DashboardScreen(pageIndex: 1)),
                  ModalRoute.withName('/index'));
            }, context),
            ...
            drawerTile("Refer and Earn", Icons.attach_money_rounded, null, context),
          ],
        ),
      ),
    );
...
Widget drawerTile(String title, IconData icon, Function()? fn, BuildContext context) {
  return Padding(
